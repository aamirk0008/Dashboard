...
const Dashboard = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen w-full">
      {/* Header Section */}
      <h1 className="text-3xl font-extrabold text-center text-gray-800 sm:text-left">Welcome Hotel Admin</h1>

      {/* Stats Section */}
      <div className="bg-gradient-to-r from-blue-500 to-blue-700 text-white p-6 mt-8 rounded-xl shadow-lg w-full">
        <div className="pb-6">
          <h2 className="text-2xl font-semibold">Hotel Status</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Total Rooms */}
          <div className="flex flex-col items-center justify-center bg-white text-gray-800 py-6 px-6 rounded-lg shadow-lg transform hover:scale-105 hover:shadow-xl transition duration-300 ease-in-out">
            <Briefcase className="text-blue-500 text-4xl mb-4" />
          ...
          {/* Total Revenue */}
          <div className="flex flex-col items-center justify-center bg-white text-gray-800 py-6 px-6 rounded-lg shadow-lg transform hover:scale-105 hover:shadow-xl transition duration-300 ease-in-out">
            <DollarSign className="text-blue-500 text-4xl mb-4" />
          ...
          {/* Total Guests */}
          <div className="flex flex-col items-center justify-center bg-white text-gray-800 py-6 px-6 rounded-lg shadow-lg transform hover:scale-105 hover:shadow-xl transition duration-300 ease-in-out">
            <User className="text-blue-500 text-4xl mb-4" />
          ...
          {/* Available Rooms */}
          <div className="flex flex-col items-center justify-center bg-white text-gray-800 py-6 px-6 rounded-lg shadow-lg transform hover:scale-105 hover:shadow-xl transition duration-300 ease-in-out">
            <Calendar className="text-blue-500 text-4xl mb-4" />
      ...
      <div className="bg-white border-t-4 border-blue-500 p-6 mt-8 rounded-xl shadow-lg w-full">
        <h2 className="text-xl font-semibold text-gray-800">Guest Management</h2>
        <button
        ...
        <div className="mt-4">
          ...
          <table className="min-w-full mt-4 border-collapse table-auto text-gray-800">
            <thead>
              <tr>
      ...
      <div className="bg-white border-t-4 border-blue-500 p-6 mt-8 rounded-xl shadow-lg w-full">
        ...
        {showAddRoomForm && (
          <div className="mt-4 p-4 bg-gray-200 rounded-lg">
            ...
            >
              <div className="mt-2">
                <label className="block text-gray-700">Room Type Name</label>
                <input
                  type="text"
                  value={newRoom.name}
        ...
        {/* Room Table */}
        <div className="mt-4">
          <h3 className="text-lg font-medium">Room Types List</h3>
          <table className="min-w-full mt-4 border-collapse table-auto text-gray-800">
            <thead>
              <tr>
                <th className="py-2 px-4 border-b text-left">Room Type</th>
